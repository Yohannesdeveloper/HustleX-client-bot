...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleCommand(raw) {
    ...
    if (/(dashboard|my dashboard|take me to dashboard|ዳሽቦርድ|እኔ ዳሽቦርድ|applications|my applications|take me to applications|አፕሊኬሽኖች|እኔ የእኔ አፕሊኬሽኖች|ማመልከቻዎች|my apps)/i.test(msg)) {
      enqueueBot("Taking you to your applications...");
      window.location.href = "https://hustlexet.vercel.app/my-applications?t=" + Date.now();
      return;
    }
